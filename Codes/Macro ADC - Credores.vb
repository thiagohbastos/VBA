...
'Macro responsável por inserir os novos registro da faixa Credores
Sub Adiciona_Registros()
    ...
    If Sheets("Credores").Range("B2").Value = "SIM" Then
        Dim tempo As Double
        ...
        AutoFilter Field:=16, Criteria1:="SOBRA REC", Operator:=xlOr, Criteria2:="=CREDITO*"
